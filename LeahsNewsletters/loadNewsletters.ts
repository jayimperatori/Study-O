...
export function getNewsletters(): Newsletter[] {
  const modules = (import.meta as any).glob('../newsletters/*.md', { eager: true, as: 'raw' }) as Record<string, string>;
  const pdfs = (import.meta as any).glob('../newsletters/*.pdf', { eager: true, as: 'url' }) as Record<string, string>;
  const docs = (import.meta as any).glob('../newsletters/*.docx', { eager: true, as: 'url' }) as Record<string, string>;
