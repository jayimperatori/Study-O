    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-orange-50 via-yellow-50 to-orange-100 py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-orange-900 mb-6 text-5xl md:text-6xl leading-none">About The Study-O</h1>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-orange-900 mb-6">Our Story 📖</h2>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-yellow-50 to-orange-50">
        <div className="max-w-4xl mx-auto text-center">
          <Heart className="w-12 h-12 text-orange-600 fill-orange-600 mx-auto mb-4" />
          <h2 className="text-orange-900 mb-6">Our Mission</h2>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <Card className="border-2 border-orange-200">
              <CardContent className="pt-6 text-center">
                <Dog className="w-8 h-8 text-orange-600 mx-auto mb-2" />
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-orange-900 mb-4">Meet Our Team 👥</h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h2 className="text-orange-900">Meet Our Dachshund Team 🌟</h2>
              <Heart className="w-8 h-8 text-orange-600 fill-orange-600" />
            </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-orange-900 mb-6">Our Cozy Learning Space 🏡</h2>
              <p className="text-gray-700 mb-4">
